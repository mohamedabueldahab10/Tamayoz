...
import { Tooltip, Box, List, ListItem, ListItemText, IconButton, Menu, MenuItem, ListItemButton, ListItemIcon, MenuList, Divider, Typography } from '@mui/material';
...
export default function Employees() {
        ...
        <Menu
          ...
          >
            <CustomListItemButton sx={{height:"30px"}}>
              <ListItemIcon>
                <PlayCircleFilledWhiteIcon sx={{color:'var(--dark-color)'}} />
              </ListItemIcon>
              <ListItemText>
                <CustomTypography >
                {t("employees.start")}
  ...
  return (
    <div>
      ...
      <Box 
      sx={{display:"flex", justifyContent:"space-between",alignItems:"center",flexWrap:"wrap", width:"100%" }}
      >
        <Box>
          <ModuleHeader>
            <Box 
            ...
            >
              <HeaderBtn onClick={() => navigate('/employees/new_employee')}>{t("employees.new")}</HeaderBtn>
            </Box>
          </ModuleHeader>
        </Box>
        <Box 
        sx={{ display: "flex", justifyContent: "center",alignItems:"end", gap: "10px" }}
        >
        <Box>
        ...
        <div>
            <Tooltip title="list">
            <ViewListIcon 
            sx={{ color: view === 'list' ? "var(--primary-color)" : "var(--secondary-color)", fontSize: "30px", cursor: "pointer" }}
        ...
        <div>
            ...
            <ViewKanbanIcon 
            sx={{ color: view === 'kanban' ? "var(--primary-color)" : "var(--secondary-color)", fontSize: "30px", cursor: "pointer" }} 
