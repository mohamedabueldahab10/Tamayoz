...
export default function PrivateInfo({ initialData }) {
  ...
  const empData = initialData?.emplyeeData;
  return (
    <>
      {loading ? (
        <Loading />
        ...
        <Box className={styles.privateInfoContainer}>
              ...
              <Box className={publicStyles.formContainer}>
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    ...
                    minWidth="180px"
                    defaultValue={
                      empData?.cities?.id === 0 ? null : empData?.cities
                    }
                    id="autostate"
                    name="city"
                    label={t('form.city')}
                ...
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    ...
                    minWidth="180px"
                    defaultValue={
                      empData?.region?.id === 0 ? null : empData?.region
                    }
                    id="autostate"
                    name="state"
                    label={t('form.state')}
              ...
              <Box className={publicStyles.formColumn}>
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    control={control}
                    defaultValue={
                      empData?.country?.id === 0 ? null : empData?.country
                    }
                    id="autocountry"
                    name="country"
              ...
              <Box className={publicStyles.formColumn}>
                ...
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    control={control}
                    defaultValue={
                      empData?.language?.id === 0 ? null : empData?.language
                    }
                    id="autolanguage"
                    name="language"
                    label={t('form.lang')}
              ...
              <Box className={publicStyles.formColumn}>
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    control={control}
                    defaultValue={
                      empData?.certificateLevel?.id === 0
                        ? null
                        : empData?.certificateLevel
                    }
                    customwidth="100%"
                    id="autocertificate"
                ...
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    control={control}
                    defaultValue={
                      empData?.fieldOfStudy?.id === 0
                        ? null
                        : empData?.fieldOfStudy
                    }
                    customwidth="100%"
                    id="autostydyfield"
                    name="stydyfield"
                ...
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    control={control}
                    defaultValue={
                      empData?.school?.id === 0 ? null : empData?.school
                    }
                    customwidth="100%"
                    id="autoschool"
                    name="school"
              ...
              <Box className={publicStyles.formColumn}>
                ...
                <Box className={publicStyles.singleRow}>
                  <CustomizedAutoComplete
                    control={control}
                    defaultValue={
                      empData?.gender?.id === 0 ? null : empData?.gender
                    }
                    customwidth="100%"
                    id="autogender"
                    name="gender"
          ...
          <BankAccountModal
            open={bankAccOpen}
            handleClose={handleCloseBankAcc}
          />
        </Box>
      )}
    </>
