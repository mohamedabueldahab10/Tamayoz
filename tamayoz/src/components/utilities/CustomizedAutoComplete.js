...
// const CustomizedAutoComplete = ({ options, name, label, control, ...props }) => {
...
//                   sx={{width:"100%"}}  
//                   {...params}
//                   label={label ? label :"Select or type"}
//                   variant="outlined"
//                   fullWidth
//                   {...props}
//                 />
...
const CustomizedAutoComplete = ({ options, defaultValue, multiple, id, getOptionLabel }) => {
  const {
    getRootProps,
    getInputLabelProps,
    getInputProps,
