...
import { Input, Button, Popover, Paper, Box, Typography, Divider, Menu } from '@mui/material';
          ...
          >
            <Box sx={paperDesign}>         
              <CategoryGroup>
                ...
                <Box sx={searchitem}><SearchItem>Upcoming Appraisals</SearchItem></Box>
                <Divider flexItem />
                <Box>
                  <Box sx={searchitem}><SearchItem>On Time Off</SearchItem></Box>
                  <Box sx={searchitem}><SearchItem>At Work</SearchItem></Box>
                </Box>
                <Divider flexItem />
                <Box>
                  <Box sx={searchitem}><SearchItem>My Team</SearchItem></Box>
                  <Box sx={searchitem}><SearchItem>My Department</SearchItem></Box>
                </Box>
                <Divider flexItem />
                <Box>
                  <Box sx={searchitem}><SearchItem>Newly Hired</SearchItem></Box>
                </Box>
                <Divider flexItem />
                <Box>
                  <Box sx={searchitem}><SearchItem>Fixed Hours</SearchItem></Box>
                  <Box sx={searchitem}><SearchItem>Flexible Hours</SearchItem></Box>
                </Box>
                <Divider flexItem />
                <Box>
                  <Box sx={searchitem}><SearchItem>Archived</SearchItem></Box>
                </Box>
              </CategoryGroup>
              ...
              <CategoryGroup>
                ...
                <Box>
                  ...
                  <Divider flexItem />
                  <Box>
                    <SearchItem sx={searchitem}># Dependent Children ...</SearchItem>
                  </Box>
                </Box>
              </CategoryGroup>
              <Divider orientation="vertical" variant="middle" flexItem />
